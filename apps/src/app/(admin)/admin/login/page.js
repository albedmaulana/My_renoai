    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="bg-white/[0.07] backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-white">Masuk ke Panel Admin</h2>
            <p className="text-sm text-slate-400 mt-1">Gunakan kredensial admin untuk mengakses panel</p>
          </div>
